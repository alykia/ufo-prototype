...
function iconSvg(def) {
    ...
    const art = {
        ...
        bakery: `<rect x="8" y="16" width="28" height="20" fill="${c}"/><rect x="10" y="18" width="24" height="5" fill="#c45a3a"/><ellipse cx="22" cy="30" rx="7" ry="4" fill="#d4a04a"/><rect x="28" y="8" width="6" height="8" fill="#8a6a50"/>`,
        butcher: `<rect x="8" y="16" width="28" height="20" fill="${c}"/><rect x="10" y="18" width="24" height="4" fill="#c02020"/><rect x="16" y="24" width="12" height="12" fill="#88b4d0"/><rect x="12" y="18" width="4" height="4" fill="#f4f4f4"/>`,
        cafe: `<rect x="10" y="16" width="24" height="18" fill="${c}"/><rect x="16" y="24" width="8" height="10" fill="#88b4d0"/><circle cx="34" cy="28" r="5" fill="#6a5030"/><rect x="18" y="8" width="8" height="6" rx="2" fill="#f4e4c0"/>`,
        supermarket: `<rect x="4" y="12" width="36" height="24" fill="${c}"/><rect x="8" y="18" width="12" height="10" fill="#88b4d0"/><rect x="24" y="18" width="12" height="10" fill="#88b4d0"/><rect x="6" y="10" width="32" height="4" fill="#3a4850"/>`,
