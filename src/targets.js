...
export const TARGETS = [
    ...
    { maps: ["zoo"], id: "penguin", label: "PENGUIN", category: "living", weightTier: 12, researchValue: 42, suspicionValue: 5, spawnWeight: 9, speedMin: 0.7, speedMax: 1.15, movable: true, spawnBand: 1, rarity: "common", colour: 0x1a1a22, size: [0.2, 0.32, 0.18], enclosure: "ice" },
    { maps: ["zoo"], id: "seal", label: "SEAL", category: "living", weightTier: 15, researchValue: 70, suspicionValue: 14, spawnWeight: 7, speedMin: 0.35, speedMax: 0.6, movable: true, spawnBand: 2, rarity: "common", colour: 0x8a8a96, size: [0.55, 0.22, 0.28], enclosure: "ice" },
    { maps: ["zoo"], id: "polarbear", label: "POLAR BEAR", category: "living", weightTier: 19, researchValue: 165, suspicionValue: 40, spawnWeight: 4, speedMin: 0.4, speedMax: 0.7, movable: true, spawnBand: 4, rarity: "uncommon", colour: 0xf2f0ea, size: [0.85, 0.52, 0.4], enclosure: "ice" },
    { maps: ["zoo"], id: "meerkat", label: "MEERKAT", category: "living", weightTier: 12, researchValue: 40, suspicionValue: 4.5, spawnWeight: 8, speedMin: 0.95, speedMax: 1.45, movable: true, spawnBand: 1, rarity: "common", colour: 0xc4a06a, size: [0.16, 0.28, 0.14], enclosure: "savanna" },
    { maps: ["zoo"], id: "flamingo", label: "FLAMINGO", category: "living", weightTier: 13, researchValue: 50, suspicionValue: 8, spawnWeight: 7, speedMin: 0.5, speedMax: 0.8, movable: true, spawnBand: 1, rarity: "common", colour: 0xf48aa8, size: [0.18, 0.48, 0.16], enclosure: "savanna" },
    { maps: ["zoo"], id: "zebra", label: "ZEBRA", category: "living", weightTier: 16, researchValue: 88, suspicionValue: 22, spawnWeight: 6, speedMin: 0.85, speedMax: 1.3, movable: true, spawnBand: 2, rarity: "uncommon", colour: 0xf0ece6, size: [0.7, 0.5, 0.32], enclosure: "savanna" },
    { maps: ["zoo"], id: "lion", label: "LION", category: "living", weightTier: 17, researchValue: 118, suspicionValue: 30, spawnWeight: 5, speedMin: 0.9, speedMax: 1.4, movable: true, spawnBand: 3, rarity: "uncommon", colour: 0xd4a03a, size: [0.72, 0.4, 0.36], enclosure: "savanna" },
    { maps: ["zoo"], id: "giraffe", label: "GIRAFFE", category: "living", weightTier: 19, researchValue: 190, suspicionValue: 44, spawnWeight: 3, speedMin: 0.45, speedMax: 0.75, movable: true, spawnBand: 4, rarity: "rare", colour: 0xd8a04a, size: [0.55, 1.15, 0.4], enclosure: "savanna" },
    { maps: ["zoo"], id: "elephant", label: "ELEPHANT", category: "living", weightTier: 20, researchValue: 260, suspicionValue: 56, spawnWeight: 2, speedMin: 0.28, speedMax: 0.48, movable: true, spawnBand: 5, rarity: "rare", colour: 0x8a8680, size: [1.15, 0.85, 0.55], enclosure: "savanna" },
    { maps: ["zoo"], id: "monkey", label: "MONKEY", category: "living", weightTier: 13, researchValue: 52, suspicionValue: 9, spawnWeight: 8, speedMin: 1.0, speedMax: 1.55, movable: true, spawnBand: 1, rarity: "common", colour: 0x8a5a32, size: [0.24, 0.3, 0.2], enclosure: "forest" },
    { maps: ["zoo"], id: "panda", label: "PANDA", category: "living", weightTier: 16, researchValue: 100, suspicionValue: 24, spawnWeight: 5, speedMin: 0.3, speedMax: 0.55, movable: true, spawnBand: 2, rarity: "uncommon", colour: 0xf4f4f4, size: [0.5, 0.42, 0.36], enclosure: "forest" },
    { maps: ["zoo"], id: "gorilla", label: "GORILLA", category: "living", weightTier: 18, researchValue: 140, suspicionValue: 34, spawnWeight: 4, speedMin: 0.4, speedMax: 0.7, movable: true, spawnBand: 3, rarity: "uncommon", colour: 0x2a2a30, size: [0.55, 0.58, 0.38], enclosure: "forest" },
    { maps: ["zoo"], id: "hippo", label: "HIPPO", category: "living", weightTier: 20, researchValue: 220, suspicionValue: 48, spawnWeight: 3, speedMin: 0.22, speedMax: 0.4, movable: true, spawnBand: 5, rarity: "rare", colour: 0x8a6a72, size: [0.95, 0.48, 0.5], enclosure: "forest" },
