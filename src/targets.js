...
export const TARGETS = [
    farm({ id: "trash", label: "TRASH CAN", category: "junk", weightTier: 1, researchValue: 1, suspicionValue: 0.8, spawnWeight: 9, speedMin: 0, speedMax: 0, movable: false, spawnBand: 1, rarity: "common", colour: 0x6d7380, size: [0.28, 0.32, 0.28] }),
    farm({ id: "gnome", label: "GNOME", category: "junk", weightTier: 1, researchValue: 2, suspicionValue: 0.9, spawnWeight: 8, speedMin: 0, speedMax: 0, movable: false, spawnBand: 1, rarity: "common", colour: 0xc45c4a, size: [0.22, 0.38, 0.22] }),
    farm({ id: "mailbox", label: "MAILBOX", category: "junk", weightTier: 1, researchValue: 2, suspicionValue: 0.9, spawnWeight: 7, speedMin: 0, speedMax: 0, movable: false, spawnBand: 1, rarity: "common", colour: 0x3d5aa8, size: [0.2, 0.4, 0.2] }),
    farm({ id: "frog", label: "FROG", category: "living", weightTier: 1, researchValue: 3, suspicionValue: 1.2, spawnWeight: 10, speedMin: 0.55, speedMax: 0.95, movable: true, spawnBand: 1, rarity: "common", colour: 0x4caf50, size: [0.26, 0.16, 0.26] }),
    farm({ id: "chicken", label: "CHICKEN", category: "living", weightTier: 1, researchValue: 5, suspicionValue: 1.5, spawnWeight: 10, speedMin: 0.5, speedMax: 0.85, movable: true, spawnBand: 1, rarity: "common", colour: 0xf0d0a0, size: [0.3, 0.22, 0.26] }),
    farm({ id: "cat", label: "CAT", category: "living", weightTier: 2, researchValue: 8, suspicionValue: 4.5, spawnWeight: 8, speedMin: 0.7, speedMax: 1.15, movable: true, spawnBand: 2, rarity: "common", colour: 0xd8a04a, size: [0.34, 0.22, 0.28] }),
    farm({ id: "dog", label: "DOG", category: "living", weightTier: 2, researchValue: 8, suspicionValue: 4.5, spawnWeight: 8, speedMin: 0.65, speedMax: 1.05, movable: true, spawnBand: 2, rarity: "common", colour: 0x8d6e4a, size: [0.4, 0.28, 0.3] }),
    farm({ id: "sheep", label: "SHEEP", category: "living", weightTier: 2, researchValue: 10, suspicionValue: 5, spawnWeight: 8, speedMin: 0.4, speedMax: 0.7, movable: true, spawnBand: 1, rarity: "common", colour: 0xece6dc, size: [0.46, 0.34, 0.36] }),
    farm({ id: "wheelbarrow", label: "WHEELBARROW", category: "vehicle", weightTier: 2, researchValue: 10, suspicionValue: 5, spawnWeight: 5, speedMin: 0, speedMax: 0, movable: false, spawnBand: 2, rarity: "common", colour: 0xb55a2a, size: [0.48, 0.28, 0.32] }),
    farm({ id: "cow", label: "COW", category: "living", weightTier: 3, researchValue: 18, suspicionValue: 11, spawnWeight: 7, speedMin: 0.35, speedMax: 0.55, movable: true, spawnBand: 2, rarity: "common", colour: 0xf2f0ea, size: [0.72, 0.42, 0.4] }),
    farm({ id: "deer", label: "DEER", category: "living", weightTier: 3, researchValue: 20, suspicionValue: 11, spawnWeight: 6, speedMin: 0.7, speedMax: 1.1, movable: true, spawnBand: 2, rarity: "common", colour: 0xa67c52, size: [0.58, 0.48, 0.32] }),
    farm({ id: "human", label: "HUMAN", category: "living", weightTier: 3, researchValue: 25, suspicionValue: 17, spawnWeight: 5, speedMin: 0.4, speedMax: 0.7, movable: true, spawnBand: 2, rarity: "uncommon", colour: 0xe0b090, size: [0.22, 0.62, 0.2] }),
    farm({ id: "motorcycle", label: "MOTORCYCLE", category: "vehicle", weightTier: 3, researchValue: 30, suspicionValue: 15, spawnWeight: 5, speedMin: 1.4, speedMax: 2.0, movable: true, spawnBand: 3, rarity: "uncommon", colour: 0xc03030, size: [0.55, 0.28, 0.28], onRoad: true }),
    farm({ id: "horse", label: "HORSE", category: "living", weightTier: 4, researchValue: 30, suspicionValue: 20, spawnWeight: 5, speedMin: 0.6, speedMax: 1.0, movable: true, spawnBand: 3, rarity: "uncommon", colour: 0x6b4a32, size: [0.78, 0.58, 0.36] }),
    farm({ id: "car", label: "CAR", category: "vehicle", weightTier: 4, researchValue: 40, suspicionValue: 24, spawnWeight: 6, speedMin: 1.2, speedMax: 1.8, movable: true, spawnBand: 3, rarity: "uncommon", colour: 0x3a6ea8, size: [0.9, 0.32, 0.42], onRoad: true }),
    farm({ id: "tractor", label: "TRACTOR", category: "vehicle", weightTier: 4, researchValue: 50, suspicionValue: 27, spawnWeight: 4, speedMin: 0.55, speedMax: 0.85, movable: true, spawnBand: 3, rarity: "uncommon", colour: 0xd4a017, size: [0.95, 0.5, 0.5], onRoad: true }),
    farm({ id: "van", label: "VAN", category: "vehicle", weightTier: 4, researchValue: 55, suspicionValue: 29, spawnWeight: 4, speedMin: 0.9, speedMax: 1.4, movable: true, spawnBand: 4, rarity: "uncommon", colour: 0xc8c2b4, size: [1.05, 0.48, 0.48], onRoad: true }),
    farm({ id: "house", label: "HOUSE", category: "structure", weightTier: 5, researchValue: 80, suspicionValue: 38, spawnWeight: 3, speedMin: 0, speedMax: 0, movable: false, spawnBand: 3, rarity: "rare", colour: 0xc47a5a, size: [1.15, 0.85, 1.05], slotted: true }),
    farm({ id: "barn", label: "BARN", category: "structure", weightTier: 5, researchValue: 90, suspicionValue: 40, spawnWeight: 3, speedMin: 0, speedMax: 0, movable: false, spawnBand: 4, rarity: "rare", colour: 0xa33a32, size: [1.4, 0.95, 1.15], slotted: true }),
    farm({ id: "theatre", label: "THEATRE", category: "structure", weightTier: 5, researchValue: 120, suspicionValue: 45, spawnWeight: 2, speedMin: 0, speedMax: 0, movable: false, spawnBand: 4, rarity: "rare", colour: 0x6a4a8a, size: [1.55, 1.0, 1.2], slotted: true }),
    farm({ id: "mall", label: "MALL", category: "structure", weightTier: 5, researchValue: 160, suspicionValue: 52, spawnWeight: 2, speedMin: 0, speedMax: 0, movable: false, spawnBand: 5, rarity: "rare", colour: 0x4a6a88, size: [1.85, 1.05, 1.35], slotted: true }),
